...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2019 at 09:43 PM
...
INSERT INTO `real_user` (`user_id`, `name`, `fname`, `lname`, `username`, `email`, `password`, `phone`, `mobile`, `address`, `city`, `zip_code`, `about`, `image`, `facebook`, `twitter`, `google`, `rss`, `status`) VALUES
